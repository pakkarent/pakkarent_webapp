...
export const productAPI = {
  ...
  getBySlug: (slug, city) => API.get(`/products/slug/${slug}/${city}`),
  legacyRedirect: (path) => API.get('/products/legacy-redirect', { params: { path } }),
...
export const categoryAPI = {
  ...
  getAllAdmin: () => API.get('/categories/admin-list'),
